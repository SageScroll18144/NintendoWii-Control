...
class Monster(Sprite):
    def __init__(self, x,y):
        ...
        self.init_image(os.path.join(base_path, 'img/monster.png'))
...
class Doodle(Sprite):
    ...
    def __init__(self, name):
        pygame.sprite.Sprite.__init__(self)
        self.name = name
        self.img_r = pygame.image.load(os.path.join(base_path, 'img/doodle.png')).convert()
...
class Platform(Sprite):
    ...
    def __init__(self, x, y):
        ...
        if type(self).__name__ == "Platform":
            self.init_image(os.path.join(base_path, 'img/greenplatform.png'))
            rnd = randint(-100, 100)
            if rnd >= 0:
...
class MovingPlatform(Platform):
    def __init__(self, x, y):
        ...
        self.init_image(os.path.join(base_path, 'img/blueplatform.png'))
...
class CrashingPlatform(Platform):
    def __init__(self, x, y):
        Platform.__init__(self, x, y)
        self.init_image(os.path.join(base_path, 'img/brownplatform.png'))
        self.ySpeed = 10
        self.crashed = 0
        self.spring = None
    
    def crash(self):
        self.init_image(os.path.join(base_path, 'img/brownplatformbr.png'))
        self.crashed = 1
...
class Spring(Sprite):
    def __init__(self, x, y):
        ...
        self.init_image(os.path.join(base_path, 'img/spring.png'))

    def compress(self):
        self.init_image(os.path.join(base_path, 'img/spring_comp.png'))
        self.compressed = 1
...
class Button(Sprite):
    ...
    def __init__(self,x,y,text):
        ...
        pygame.sprite.Sprite.__init__(self)
        self.img_sel = pygame.image.load(os.path.join(base_path, 'img/menu_selected.png')).convert()
        self.img_unsel = pygame.image.load(os.path.join(base_path, 'img/menu_unselected.png')).convert()
